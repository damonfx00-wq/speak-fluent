                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <Label>Weak Areas (Select all that apply)</Label>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {['Fluency', 'Vocabulary', 'Grammar', 'Pronunciation'].map((area) => (
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                if (e.target.checked) {
                                  setFormData({
                                    ...formData,
                                    weakAreas: [...formData.weakAreas, area]
                                  });
                                } else {
                                  setFormData({
                                    ...formData,
                                    weakAreas: formData.weakAreas.filter(a => a !== area)
                                  });
                                }
                              }}
